...
public class AudioManager : SingletonPersistent<AudioManager>
{
    ...
    public void ToggleSFX()
    {
        ...
        PlayerPrefs.SetInt("SFX_Toggle", _sfxSource.mute ? 0 : 1);
        PlayerPrefs.Save();
    }
    ...
    public void ToggleMusic()
    {
        ...
        PlayerPrefs.SetInt("Music_Toggle", _musicSource.mute ? 0 : 1);
        PlayerPrefs.Save();
    }

    private void LoadAudioPrefs()
    {
        _sfxSource.mute = PlayerPrefs.GetInt("SFX_Toggle", 1) != 1;
        _musicSource.mute = PlayerPrefs.GetInt("Music_Toggle", 1) != 1;
    }
}
